...
import { accountDataReducer } from '../redux/Reducers/accountDataReducer';
import { getAccountDataAction } from '../redux/Actions/getAccountData';

function PanchayatAccount() {
                ...
                <form>
                    <div className='form-container'>
                        ...
                        <div className='form-colm'>
                            ...
                            <TextField name='panchayat' type='name' className='text-field' fullWidth id="outlined-basic" variant="outlined" value={profile?.panchayatMaster?.name} disabled="true"/>
                        </div>
                    </div>
...
export default PanchayatAccount
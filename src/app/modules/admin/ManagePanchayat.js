...
const sectors = [
    {id:0, blockName:'All'},
    {id:1, blockName:'Agriculture and Allied Sector',},
    {id:3, blockName:'Health and Nutrition',},
    {id:4, blockName:'Education',},
    {id:5, blockName:'Rural Development and Sanitation',},
    {id:6, blockName:'Individual Beneficiary schemes',},
    {id:7, blockName:'Skill Development and Employment',},
    {id:8, blockName:'Basic Infrastructure',},
    {id:9, blockName:'Environment',},
    {id:10, blockName:'Governance',},
];
            ...
            <div className='body-div'>
                <div className='filter-div'>
                    ...
                    <div style={{ display: 'flex', width:"70%" , justifyContent:'flex-end'}}>
                        <SearchComponent />
                        <FilterComponent options={sectors} label={"Sector"} width={FilterWidth}/>
                    </div>
                </div>
...
export default ManagePanchayat